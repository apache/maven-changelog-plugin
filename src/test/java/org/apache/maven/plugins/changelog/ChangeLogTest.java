...
class ChangeLogTest {
    ...
    void testReadFile() throws Exception {
        ...
        assertEquals(2, changelogSets.getChangeSets().size(), "Test number of revisions on changelog 1");
        ...
        assertEquals(2, changelogSets.getChangeSets().size(), "Test number of revisions on changelog 2");
